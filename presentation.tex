...
\newcommand{\incstr}[1]{\vcenter{\hbox{\includegraphics[scale=0.55]{figures/#1}}}} % including string diagrams

\title[]{The Quantum Marginals Problem}
\date[]{} % Removing the date.
\AtBeginSection[]{
...
\begin{withoutheadline}
    \begin{frame}
        ...
        \vspace{-0.2in}
        \begin{center}
            {\footnotesize TC Fraser} \\
            \vspace{0.8em}
            {\scriptsize Quantum Foundations Group Meeting \\ March 6th, 2019}
        \end{center}
    \end{frame}
\end{withoutheadline}
...
\begin{frame}
    ...
    \begin{alertblock}{}
        ...
        \hspace*\fill{\small--- B. E. Borland, K. Dennis}
    \end{alertblock}
